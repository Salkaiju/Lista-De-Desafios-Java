...
import Desafios_Modulo3_Alura_Orientacao_a_Objetos.Desafio1.Modulo4Carro;
import Desafios_Modulo3_Alura_Orientacao_a_Objetos.Desafio2.Cachorro;
import Desafios_Modulo3_Alura_Orientacao_a_Objetos.Desafio2.Gato;
import Desafios_Modulo3_Alura_Orientacao_a_Objetos.Desafio3.Modulo3ContaBancaria;
import Desafios_Modulo3_Alura_Orientacao_a_Objetos.Desafio4.VerificadorPrimo;
            ...
            switch (opcao) {
                ...
                case 3:{
                    ...
                    switch (opcao) {
                        ...
                        case 3: {
                            do {
                                valorInt = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite o que fazer com sua conta do banco: \n" +
                                        "0-Finalizar.\n" +
                                        "1-Depositar.\n" +
                                        "2-Sacar.\n" +
                                        "3-Exibir saldo.\n"));
                                switch (valorInt) {
                                    case 0: {
                                        System.out.println("Finalizando e retornando...");
                                    }
                                    break;
                                    case 1: {
                                        depositar(Double.parseDouble(JOptionPane.showInputDialog(null, "Quanto?")));
                                    }
                                    break;
                                    case 2: {
                                        sacar(Double.parseDouble(JOptionPane.showInputDialog(null, "Quanto?")));
                                    }
                                    break;
                                    case 3: {
                                        consultarSaldo();
                                    ...
                                    break;
                                    default: {
                                        JOptionPane.showMessageDialog(null, "Erro. Digite um número INT de 0 a 3.");
                                    }
                                }
                            }while (valorInt != 0);
                        }
                        ...
                        case 4: {
                            do {
                                valorInt = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite 0 para retornar.\nDigite 1 para adicionar um novo número primo aleatório.\n" +
                                        "0-Finalizar.\n" +
                                        "1-Gerar um número primo.\n" +
                                ...
                                switch (valorInt) {
                                    ...
                                    break;
                                    case 1: {
                                        verificador.verificarPrimo(Integer.parseInt(JOptionPane.showInputDialog(null, "Qual número")));
                                    } break;
                                    case 2:{
                                        verificador.listarPrimos(Integer.parseInt(JOptionPane.showInputDialog(null, "Até quanto")));
                                    }break;
                                    default: {
                                        JOptionPane.showMessageDialog(null, "Erro. Digite um número INT de 0 a 2.");
                                    }
                                }
                            } while (valorInt != 0);
                        } break;
